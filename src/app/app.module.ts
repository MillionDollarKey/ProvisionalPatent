...
import {
  MatButtonModule, MatSelectModule, MatAutocompleteModule,
  MatCheckboxModule, MatToolbarModule, MatCardModule, MatDividerModule
...
@NgModule({
  ...
  entryComponents: [SelectElementComponent, EditDialogComponent, AddElementComponent,
